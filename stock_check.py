...
def product_publisher(product_xml):
    ...
    # Publish the message to the exchange with routing key 'product.inventory'
    channel.basic_publish(exchange=exchange_name, routing_key='product.inventory', body=product_xml)
...
def get_stock():
    ...
    stock_url = "http://http://10.2.160.51:880/api/stock/"

    category_url = "http://http://10.2.160.51:880/api/part/category/"
    ...
    for item in data:
        ...
        item_url = f"http://http://10.2.160.51:880/api/part/{part_id}/"

...
function stockLocationTypeFields() {
    const fields = {
        ...
        description: {},
        icon: {
            help_text: `Default icon for all locations that have no icon set (optional) - Explore all available icons on <a href="https://fontawesome.com/v5/search?s=solid" target="_blank" rel="noopener noreferrer">Font Awesome</a>.`,
    ...
    if (!options.onSuccess) {
        options.onSuccess = function(response) {
            ...
            if (response.pk) {
                ...
                addCachedAlert('Создана новая складская позиция', {
                    icon: 'fas fa-boxes',
                });
                ...
                showMessage('Создано несколько складских позиций', {
                    icon: 'fas fa-boxes',
                    details: details,
                });
...
function loadStockTable(table, options) {
    ...
    if (!options.disableFilters) {
        ...
        setupFilterList(filterKey, table, filterTarget, {
            ...
            singular_name: 'складская позиция',

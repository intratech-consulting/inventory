...
function stockLocationTypeFields() {
    const fields = {
        ...
        description: {},
        icon: {
            help_text: `Ícone padrão para todas as locações que não têm um ícone definido (opcional) - Explorar todos os ícones disponíveis em <a href="https://fontawesome.com/v5/search?s=solid" target="_blank" rel="noopener noreferrer">Font Awesome</a>.`,
...
function stockLocationFields(options={}) {
    var fields = {
        ...
        custom_icon: {
            help_text: `Ícone (opcional) - Explorar todos os ícones disponíveis em <a href="https://fontawesome.com/v5/search?s=solid" target="_blank" rel="noopener noreferrer">Font Awesome</a>.`,
            placeholder: 'fas fa-box',
            icon: "fa-icons",
        },
    };

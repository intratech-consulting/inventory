...
function createNewModal(options={}) {
    ...
    if (!options.hideSubmitButton) {
        buttons += `<button type='button' class='btn btn-${submitClass}' id='modal-form-submit'>Подтвердить</button>`;
    }
    ...
    modalSetSubmitText(modal_name, options.submitText || 'Подтвердить');
...
function openModal(options) {
    ...
    var submit_text = options.submit_text || 'Подтвердить';

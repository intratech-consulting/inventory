            ...
            },
            {
                ...
                formatter: function(value, row) {
                    ...
                    if (options.custom && !row.is_builtin && row.is_installed) {
                        if (row.active) {
                            buttons += makeIconButton('fa-stop-circle icon-red', 'btn-plugin-disable', row.pk, 'Desativar Plug-in');
                        } else {
                            buttons += makeIconButton('fa-play-circle icon-green', 'btn-plugin-enable', row.pk, 'Habilitar Plug-in');
                        }
                    }
